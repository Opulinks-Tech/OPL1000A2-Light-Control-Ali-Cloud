...
void Ali_Hal_Devive_init(){
    T_MwFim_GP12_AliyunDevice AliyunDevice;
	
    // get the settings of power saving
    if (MW_FIM_OK != MwFim_FileRead(MW_FIM_IDX_GP12_PROJECT_ALIYUN_DEVICE, 0, MW_FIM_GP12_ALIYUN_DEVICE_SIZE, (uint8_t*)&AliyunDevice))
    {
        // if fail, get the default value
        memcpy(&AliyunDevice, &g_tMwFimDefaultGp12AliyunDevice, MW_FIM_GP12_ALIYUN_DEVICE_SIZE);
    }
