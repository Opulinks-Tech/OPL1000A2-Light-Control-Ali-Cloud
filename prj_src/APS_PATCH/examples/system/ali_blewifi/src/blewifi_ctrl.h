...
typedef enum blewifi_ctrl_msg_type
{
    ...
    BLEWIFI_CTRL_MSG_NETWORKING_LED_TIMEOUT,    //Networking LED Time Out
    ...
    BLEWIFI_CTRL_MSG_DEV_SCHED_START,               //Device Schedule Start

    BLEWIFI_CTRL_MSG_LIGHT_DRV_TIMEOUT,             //Light Driver Time Out
    BLEWIFI_CTRL_MSG_LIGHT_CTRL_TIMEOUT,            //Light Control Time Out
...
typedef struct
{
    ...
    #ifdef BLEWIFI_SCHED_EXT
    T_MwFim_GP16_Dev_Sched_Ext taSchedExt[MW_FIM_GP13_DEV_SCHED_NUM];
    #endif
...
typedef struct
{
    ...
    #ifdef BLEWIFI_SCHED_EXT
    T_MwFim_GP16_Dev_Sched_Ext *ptSchedExt;
    #endif
