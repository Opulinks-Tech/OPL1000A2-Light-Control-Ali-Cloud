...
#define WIFI_OTA_UPGRADE_URL     "http://192.168.0.100/ota.bin"
...
// Aliyun Device
/*
// user need to apply Ali 5 key to replace below macro-definition 
...
#define ALI_PRODUCT_ID              (2310002)
#define ALI_PRODUCT_KEY             "a1RDpZaLeiC"
#define ALI_PRODUCT_SECRET          "BEoORXquWH0bqbU5"
#define ALI_DEVICE_NAME             "Ali_LED_test_device_01"
#define ALI_DEVICE_SECRET           "2CpA0Gi1jbwkrQnQM67amWlfD5ZmQkyM"
